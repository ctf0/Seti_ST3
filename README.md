...
#### Options
`Themr` have an option call ``Themr: Toggle Theme Settings`` to change theme settings on-the-fly without doing that manually ,or copy and paste the one u need.
